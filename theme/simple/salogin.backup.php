...
<head>
    ...
    <style>
      ...
      .pwa-loader img { width: 96px; height: auto; animation: floatLogo 1.8s ease-in-out infinite; border-radius: 12px; box-shadow: 0 8px 24px rgba(218,165,32,0.4); }
      @keyframes floatLogo { 0%{ transform: translateY(0);} 50%{ transform: translateY(-10px);} 100%{ transform: translateY(0);} }
      #pwa-install-prompt { position: fixed; left: 0; right: 0; bottom: 20px; display: none; z-index: 9999; }
...
<body>
  ...
  <!-- Floating loading overlay (center) -->
  <div id="pwa-loader" class="pwa-loader" aria-hidden="true">
    <img src="/upload/epic-hub.jpg" alt="Loading" />
  </div>

  <!-- Minimal, non-intrusive install prompt -->
  ...
  <script>
    ...
    (function(){
      ...
      window.addEventListener('load', function(){ if (loaderEl) loaderEl.style.display = 'none'; });
    })();
