...
// Ambil link sertifikat EPIC dari mem_datalain
$epic_certificate_link = '';
if (!empty($datamember['mem_datalain'])) {
    $raw_datalain = $datamember['mem_datalain'];
    $extra = json_decode($raw_datalain, true);
    if (is_array($extra)) {
        // Normalisasi keys dan cari beberapa sinonim yang umum digunakan
        foreach ($extra as $k => $v) {
            $key = strtolower(str_replace([' ', '_'], '', $k));
            if (in_array($key, [
                'linksertifikatepic',        // dari dashimport
                'linksertifikatepi',         // toleransi penamaan
                'epiccertificate',           // sinonim Inggris
                'linkepic',                  // variasi umum
                'sertifikatepic'             // variasi tanpa kata 'link'
            ], true)) {
                if (is_string($v)) { $epic_certificate_link = trim($v); }
            }
        }
        // Fallback exact matches
        if (empty($epic_certificate_link)) {
            if (isset($extra['linksertifikatepic']) && is_string($extra['linksertifikatepic'])) {
                $epic_certificate_link = trim($extra['linksertifikatepic']);
            } elseif (isset($extra['Link Sertifikat EPIC']) && is_string($extra['Link Sertifikat EPIC'])) {
                $epic_certificate_link = trim($extra['Link Sertifikat EPIC']);
            } elseif (isset($extra['link_sertifikat_epic']) && is_string($extra['link_sertifikat_epic'])) {
                $epic_certificate_link = trim($extra['link_sertifikat_epic']);
            }
        }
    } else {
        // Fallback parsing non-JSON: cari pola "Link Sertifikat EPIC" diikuti URL
        if (preg_match('/Link\s*Sertifikat\s*EPIC.*?(https?:\/\/[^\s]+)/i', $raw_datalain, $m)) {
            $epic_certificate_link = trim($m[1]);
        } elseif (preg_match('/sertifikat.*?(https?:\/\/[^\s]+)/i', $raw_datalain, $m)) {
            $epic_certificate_link = trim($m[1]);
        }
    }
}
// Validasi URL
if (!empty($epic_certificate_link)) {
    $epic_certificate_link = filter_var($epic_certificate_link, FILTER_VALIDATE_URL) ? $epic_certificate_link : '';
}
...
<style>
        * {
        ...
        @keyframes sparkle {
            0% { transform: rotateX(-100%) translateY(-100%) rotate(45deg); }
            100% { transform: rotateX(100%) translateY(100%) rotate(45deg); }
        }
    </style>
</head>
<body>
    ...
    <header class="member-header">
        <div class="header-container">
            ...
            <nav class="header-nav" id="headerNav">
                ...
                <a href="/product" class="nav-item">📚 e-Course</a>
    ...
    <div class="container">
            ...
            <div class="video-section">
                ...
                <div class="video-container">
                    <iframe 
                        src="https://www.youtube.com/embed/7wTh7zrjyCI?rel=0&modestbranding=1&showinfo=0&controls=1&autoplay=0" 
            ...
            <div class="landing-page-section">
                <h2 class="section-title">🚀 Landing Page Tersedia</h2>
                <p class="section-description">Akses landing page yang tersedia untuk mendukung bisnis Anda</p>
                
                <div id="landingPageContainer" class="landing-page-grid">
                    <div class="loading-state">
                        <div class="loading-spinner"></div>
                        <p>Memuat data landing page...</p>
                    </div>
                </div>
                
                <div class="landing-page-stats" id="landingPageStats" style="display: none;">
                    <p class="stats-text">
                        <span id="totalPages">0</span> landing page tersedia | 
            ...
            <div class="access-section">
                ...
                <div class="access-grid">
                    <div class="access-item">
                        <h3 style="color: #25D366; margin-bottom: 15px;">📱 Grup WhatsApp Resmi</h3>
                        <p style="margin-bottom: 15px; color: #5d4e37;">Grup WhatsApp Resmi EPI Channel, akses link ini hanya untuk Anda dan dilarang membagikan dalam cara apapun</p>
                    ...
                    <div class="access-item">
                        ...
                        <p style="margin-bottom: 15px; color: #5d4e37;">Pilih channel Marketing Kit yang Anda perlukan:</p>
                        <div class="mk-btn-group" style="display:flex; flex-wrap:wrap; gap:10px; justify-content:center;">
                            <a href="https://t.me/+IhFb7vxTwY80MDA1" class="access-btn" target="_blank" style="background: linear-gradient(45deg, #0088cc, #00aaff);">
                                Silvergram
                            </a>
                            <a href="https://t.me/+pZFOTMc5EEZkYzJl" class="access-btn" target="_blank" style="background: linear-gradient(45deg, #0088cc, #00aaff);">
                                Goldgram
                            </a>
                            <a href="https://t.me/+urLgyOiu03Q2ZDA1" class="access-btn" target="_blank" style="background: linear-gradient(45deg, #0088cc, #00aaff);">
                                Meezan Gold
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="access-item">
                        <h3 style="color: #d4af37; margin-bottom: 15px;">🔐 Akses OMS EPIC</h3>
                        <p style="margin-bottom: 15px; color: #5d4e37;">Order Management System adalah alat untuk melakukan transaksi bagi EPI Channel ke EPI Store</p>
            ...
            <div class="access-section">
                ...
                <div class="access-grid">
                    <div class="access-item">
                        ...
                        <a href="https://whatsapp.com/channel/0029Vb7JR2JIHphG4EFIgh1Y" class="access-btn" target="_blank" style="background: linear-gradient(45deg, #25D366, #128C7E);">
                            Follow Channel
                        </a>
                    </div>
                    ...
                    <div class="access-item">
                        ...
                        <a href="https://instagram.com/emasperakindonesia" class="access-btn" target="_blank" style="background: linear-gradient(45deg, #E4405F, #C13584);">
                            Follow Instagram
                        </a>
                    </div>
                </div>
            ...
            <div class="access-section">
                ...
                <div class="access-grid">
                    ...
                    <div class="access-item">
                        ...
                        <a href="https://heyzine.com/flip-book/04903c26b3.html" class="access-btn" target="_blank">
                            Download Profile
                        </a>
                    </div>

                    <div class="access-item">
                        <h3 style="color: #d4af37; margin-bottom: 15px;">🎓 Sertifikat Digital</h3>
                        <p style="margin-bottom: 15px; color: #5d4e37;">Sertifikat Digital EPIC</p>
                        <?php if (!empty($epic_certificate_link)) : ?>
                            <a href="<?php echo htmlspecialchars($epic_certificate_link, ENT_QUOTES, 'UTF-8'); ?>" class="access-btn" target="_blank">
                                Download Sertifikat Saya
                            </a>
                        <?php else : ?>
                            <button class="access-btn" style="background: #aaa; cursor: not-allowed;" disabled>
            ...
            <!-- Katalog Produk: disisipkan setelah 'Download Dokumen' -->
            <div class="access-section">
                <h2 class="section-title">Katalog Produk</h2>
                
                <div class="access-grid">
                    <!-- Card: Katalog Goldgram -->
                    <div class="access-item">
                        <h3 style="color: #d4af37; margin-bottom: 15px;">🥇 Katalog Goldgram</h3>
                        <p style="margin-bottom: 15px; color: #5d4e37;">Silakan download untuk keperluan promosi produk Goldgram</p>
                        <a href="https://heyzine.com/flip-book/38af22792e.html" class="access-btn" target="_blank">
                            Buka Katalog Goldgram
                        </a>
                    </div>

                    <!-- Card: Katalog Silvergram -->
                    <div class="access-item">
                        <h3 style="color: #8c8c8c; margin-bottom: 15px;">🥈 Katalog Silvergram</h3>
                        <p style="margin-bottom: 15px; color: #5d4e37;">Silakan download untuk keperluan promosi produk Silvergram</p>
                        <a href="https://heyzine.com/flip-book/b82a55ee29.html" class="access-btn" target="_blank">
                            Buka Katalog Silvergram
                        </a>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setInterval(loadLandingPages, 300000);
        });

        // Landing Page Functions
        async function loadLandingPages() {
            const container = document.getElementById('landingPageContainer');
            const statsContainer = document.getElementById('landingPageStats');
            
            try {
                const response = await fetch('/api/landing-pages.php');
            ...
            const html = pages.map(page => `
                <div class="landing-page-item">
                    ...
                    <div class="landing-page-description">
                        ${escapeHtml(page.description || 'Tidak ada deskripsi tersedia')}
                    </div>
                    <div class="landing-page-url">
                        📍 ${escapeHtml(page.full_url)}
                    </div>
                    <div class="landing-page-actions">
                        <a href="${escapeHtml(page.full_url)}" 
                           target="_blank" 
                        ...
                        <button class="copy-btn" 
                                onclick="copyToClipboard('${escapeHtml(page.full_url)}', this)"
                                title="Salin URL">
                            <span class="copy-icon">📋</span>
                            <span class="copy-text">Salin URL</span>
                            <div class="copy-tooltip">Klik untuk menyalin URL</div>
                        </button>
                    </div>
                </div>
            `).join('');
        ...
        function showEmptyState() {
            ...
            container.innerHTML = `
                <div class="loading-state">
                    <p>📄 Belum ada landing page yang tersedia</p>
                    <p style="font-size: 0.9rem; color: #8b7355; margin-top: 10px;">
                        Landing page akan muncul di sini setelah dibuat di dashboard
                    </p>
                </div>
            `;
        }
        ...
        function showErrorState() {
            ...
            container.innerHTML = `
                <div class="error-state">
                    <p>⚠️ Gagal memuat data landing page</p>
        ...
        function showCopySuccess(button) {
            ...
            originalText.textContent = 'Tersalin!';
            
            // Tampilkan tooltip sukses
            tooltip.textContent = 'URL berhasil disalin!';
            ...
            setTimeout(() => {
                ...
                originalIcon.textContent = '📋';
                originalText.textContent = 'Salin URL';
                tooltip.textContent = 'Klik untuk menyalin URL';
        ...
        function showCopyError(button) {
            ...
            tooltip.textContent = 'Gagal menyalin URL';
